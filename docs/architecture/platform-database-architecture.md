...
> **⛳ This is the *original* (2026-06-16) target.** It kicked off the DB-redesign dialectic (audit → elimination → codd → pillars → reality-first → conceptual-critique → the 2026-07-05 synthesis). Read it for origin/evidence; the accepted model is the synthesis.
