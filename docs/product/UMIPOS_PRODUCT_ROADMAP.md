...
| 3F Customers, loyalty, and stored value | Incomplete                 | 3E                     | Complete Gate 3F authority                | Policy binding, expiry, operations, rate limits, and concurrency remain | Core contract, API, Flutter, PostgreSQL, RLS, Linux, and Web checks passed                                               |

The latest relevant revision is the Gate 3F commit in PR #72.
...
Gate 3F adds a safe customer-value foundation. It includes scoped customers, immutable ledgers,
stored-value authorization, checkout integration, refund compensation, RLS, and protected codes.
Full policy binding, expiry, operational mutations, rate limits, and concurrency coverage remain.
Gate 3G has not started and is not authorized.
