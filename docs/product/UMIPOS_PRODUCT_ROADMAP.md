...
| 5A Dashboard operational completion     | Incomplete                 | 4A                     | Run authenticated end-to-end validation   | Authority matrix and P0 walkthrough use mocked domain services | Command wiring, hardware relay, PostgreSQL, Flutter, Dashboard, and contract checks passed                               |

The latest relevant revision is the Gate 5A operational wiring commit in PR #72.
...
Gate 5A requires an authenticated end-to-end authority matrix and P0 mutation walkthrough.
Gate 6A is not authorized and has not started.
