...
| 3F Customers, loyalty, and stored value | Planned                    | 3E                     | Approve the Gate 3F scope                 | Gate sequence approval                               | Not run                                                                                                                  |

The latest relevant revision is the Gate 3E commit in PR #72.
PR #72 keeps Gate 3A through Gate 3E complete on current `build-v3`.
...
online-only. Gate 3F has not started.
