...
The latest relevant revision is the Gate 9A certification commit in PR #72.
PR #72 keeps Gates 3A through 9A complete with recorded observations.
...
Gate 9A passed the first pilot rehearsal. Gate 9B is authorized with observations and has not started.
