        ...
        <div className="grid grid-cols-2 md:grid-cols-[2fr_1fr_1fr_1fr] gap-12 pb-14 border-b border-[var(--stroke)]">
          <div>
            ...
            <p className="text-[14px] leading-[1.65] font-medium text-white/68 max-w-[300px] mt-5">
              Sistema operativo para restaurantes conectados. Culiacán · Ciudad de México · Desde
              2021.
            </p>
          </div>

          <div className="flex flex-col gap-3">
            <div className="text-[11px] uppercase text-[#BFD1F2] font-extrabold mb-2">Umi</div>
            {['Misión', 'Equipo', 'Prensa', 'Contacto'].map((t) => (
              <Link
                key={t}
                href="#"
                className="text-sm text-white/68 hover:text-umi-ink transition-colors"
              >
                {t}
              </Link>
            ))}
          ...
          <div className="flex flex-col gap-3">
            <div className="text-[11px] uppercase text-[#BFD1F2] font-extrabold mb-2">Legal</div>
