...
const I = {
  ...
  // The POS register. It sits beside `Tablet` on the Devices screen, so the two must
  // read apart at 18px: a screen on a stand against a hand-held slab.
  Monitor: (p) => (
    <Icon {...p}>
  ...
  WhatsApp: (p) => (
    <Icon {...p}>
      <path d="M21 12a9 9 0 1 1-3.55-7.16L21 4l-1.16 3.54A9 9 0 0 1 21 12z" />
      <path d="M8 11a3 3 0 0 0 1 2 4 4 0 0 0 3 2l2-2-2-1-1 1a3 3 0 0 1-2-2l1-1-1-2-2 1z" />
    </Icon>
  ),
  Sparkles: (p) => (
    <Icon {...p}>
  ...
  Megaphone: (p) => (
    <Icon {...p}>
      ...
      <path d="M11.6 19.6a3 3 0 1 1-5.2-3" />
    </Icon>
  ),
  Palette: (p) => (
    <Icon {...p}>
      ...
      <path d="M12 2a10 10 0 1 0 0 20c1.1 0 2-.9 2-2v-1a2 2 0 0 1 2-2h3a4 4 0 0 0 4-4 10 10 0 0 0-10-11z" />
    </Icon>
  ),
  Store: (p) => (
    <Icon {...p}>
  ...
  Stamp: (p) => (
    <Icon {...p}>
      <path d="M5 22h14" />
      <path d="M19.27 17H4.73L3 22h18l-1.73-5z" />
      <path d="M14 14V8.5a2.5 2.5 0 0 0-5 0V14" />
      <path d="M9 14h6" />
    </Icon>
  ),
  ArrowRight: (p) => (
  ...
  Package: (p) => (
    <Icon {...p}>
      <path d="M12 22l-7-4V9l7-4 7 4v9l-7 4z" />
  ...
  SortDesc: (p) => (
    <Icon {...p}>
      ...
      <line x1="11" y1="9" x2="5" y2="9" />
      <line x1="11" y1="13" x2="7" y2="13" />
      <polyline points="15 9 18 12 21 9" />
