...
for f in 00_foundation 10_umi 20_merchant 30_runtime 50_cross_schema_fk 60_triggers 90_rls 99_verify; do
...
insert into merchant.staff (id,merchant_id,location_id,user_id) values ('$S1','$A','$A1','$U1');
